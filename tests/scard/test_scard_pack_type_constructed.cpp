...
RED_AUTO_TEST_CASE(test_scard_pack_type_constructed_reader_state_1)
{
...
RED_AUTO_TEST_CASE(test_scard_pack_type_constructed_reader_state_2)
{
   SCARD_READERSTATE native_reader_state;
   {
...
RED_AUTO_TEST_CASE(test_scard_pack_type_constructed_reader_state_3)
{
   SCARD_READERSTATE native_reader_state;
   {
...
RED_AUTO_TEST_CASE(test_scard_pack_type_constructed_pci_1)
{
...
RED_AUTO_TEST_CASE(test_scard_pack_type_constructed_pci_2)
{
   std::array<uint8_t, sizeof(SCARD_IO_REQUEST) + 30> native_pci_data;
   {
      ...
      {
         native_pci.dwProtocol = 0x01;
         native_pci.cbPciLength = (native_pci_data.size() - sizeof(SCARD_IO_REQUEST));
      }
