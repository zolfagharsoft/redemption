...
public:
    ...
    ///
    virtual ~scard_pack_virtual_type() = default;
...
class scard_pack_context : public scard_pack_virtual_type<SCARDCONTEXT>
{
...
class scard_pack_handle : public scard_pack_virtual_type<SCARDHANDLE>
{
    typedef scard_pack_array_primitive<
        uint8_t, 16,
        scard_pack_array_type_conformant,
...
class scard_pack_reader_state : public scard_pack_virtual_type<SCARD_READERSTATE>
{
    typedef std::array<
        uint8_t, 36
    > atr_array_type;
...
{
    SCARD_PACK_NATIVE_PCI_HEADER    _header;
...
class scard_pack_pci : public scard_pack_virtual_type<scard_pack_native_pci>
{
    typedef scard_pack_array_primitive<
        uint8_t, 1024,
        scard_pack_array_type_conformant,
