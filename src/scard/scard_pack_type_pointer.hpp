...
public:
        ...
        pointer_index_type &/*pointer_index*/)
    {
        ...
        n_unpacked = sizeof(uint32_t);
/*
        SCARD_CHECK_PREDICATE((referent_id == scard_pack_array_referent_id_null) || (
            ((referent_id & scard_pack_array_referent_id_base) == scard_pack_array_referent_id_base) &&
            ((referent_id & ~scard_pack_array_referent_id_base) == index)),
            ERR_SCARD);
*/
...
*/        
        ...
        pointer_index_type &pointer_index)
    {
        ...
        // padding
        //n_unpacked += unpad(stream, _elements.size());
