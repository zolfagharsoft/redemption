...
class SmartcardMod : public mod_api, public NotifyApi
{
    ...
    std::unique_ptr<scard_manager> manager;
...
public:
    ...
    ~SmartcardMod() override;

    void init() override;

    std::string module_name() override { return "SmartcardMod"; }
